    ...
    <div className="py-10">
      <header>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold leading-tight text-gray-900">Content Schedule</h1>
        </div>
      </header>
      <main>
          ...
          <div className="px-4 py-8 sm:px-0">
            <div className="bg-white shadow overflow-hidden sm:rounded-lg p-6">
              ...
              <div className="mt-6 border-t border-gray-200 pt-6">
                ...
                <p className="text-gray-500 italic">No scheduled content yet. Create your first scheduled post to get started.</p>
