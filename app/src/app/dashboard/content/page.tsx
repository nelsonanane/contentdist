    ...
    <div className="py-10">
      <header>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold leading-tight text-gray-100">Content Management</h1>
        </div>
      </header>
      <main>
          ...
          <div className="px-4 py-8 sm:px-0">
            <div className="bg-gray-800 shadow overflow-hidden sm:rounded-lg p-6">
              ...
              <div className="mt-6 border-t border-gray-700 pt-6">
                <h2 className="text-xl font-semibold text-gray-100 mb-4">Your Content</h2>
                <p className="text-gray-400 italic">No content items yet. Create your first content piece to get started.</p>
